 ...
 */
public class CCustomDialog extends Dialog {

    public CCustomDialog(Context context) {
        super(context);
    }

    public CCustomDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public CCustomDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final CCustomDialog dialog = new CCustomDialog(context, R.style.Dialog);
