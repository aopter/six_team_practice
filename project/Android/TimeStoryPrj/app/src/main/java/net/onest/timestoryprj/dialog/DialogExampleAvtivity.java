...
public class DialogExampleAvtivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dialog_example_avtivity);
...
//        u0_a280   8011  2923  1474704 209280 SyS_epoll_ 0000000000 S me.leefeng.beida
        ...
        findViewById(R.id.main_ad).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(getApplicationContext()).load("https://timgsa.baidu.com/timg?image&quality=80&" +
...
//                        .placeholder(getResources().getDrawable(R.drawable.ic_prompt_holder))
                        .into(promptDialog.showAd(true, new OnAdClickListener() {
                            ...
                            public void onAdClick() {
                                Toast.makeText(getApplicationContext(), "点击了广告", Toast.LENGTH_SHORT).show();
                            }
                        }));
            }
        });
