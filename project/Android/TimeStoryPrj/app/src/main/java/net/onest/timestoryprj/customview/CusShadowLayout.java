...
public class CusShadowLayout extends RelativeLayout {
    ...
    public CusShadowLayout(Context context) {
        this(context, null);
    }

    public CusShadowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CusShadowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
